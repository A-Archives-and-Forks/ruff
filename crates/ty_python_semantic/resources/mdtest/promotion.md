...
reveal_type(segments)  # revealed: list[tuple[int, int, int, int, int] | tuple[int] | tuple[int, int, int, int] | tuple[int, int] | tuple[int, int, int]]
segments.append((6, 7, 8, 9, 10))

starred_segments = [*get_segments(), (1, 2), (3, 4, 5)]
reveal_type(starred_segments)  # revealed: list[tuple[int, int, int, int] | tuple[int, int] | tuple[int, int, int]]
starred_segments.append((6, 7, 8, 9))
...
reveal_type(aliased_segments)  # revealed: list[tuple[int, int, int, int] | tuple[int, int] | tuple[int, int, int]]
aliased_segments.append((6, 7, 8, 9))

def get_newtype_segment() -> NewTypeSegment:
    return NewTypeSegment((0, 1))

newtype_segments = [get_newtype_segment(), (1, 2), (3, 4, 5)]
reveal_type(newtype_segments)  # revealed: list[tuple[int, int, int, int] | tuple[int, int] | tuple[int, int, int]]
newtype_segments.append((6, 7, 8, 9))

def check_bound_typevar_segment(segment: BoundSegment) -> None:
    bound_typevar_segments = [segment, (1, 2), (3, 4, 5)]
    reveal_type(bound_typevar_segments)  # revealed: list[tuple[int, int, int, int] | tuple[int, int] | tuple[int, int, int]]
    bound_typevar_segments.append((6, 7, 8, 9))

def check_constrained_typevar_segment(segment: ConstrainedSegment) -> None:
    constrained_typevar_segments = [segment, (1, 2), (3, 4, 5)]
    # revealed: list[tuple[int, int, int, int] | ConstrainedSegment@check_constrained_typevar_segment | tuple[int, int] | tuple[int, int, int]]
    reveal_type(constrained_typevar_segments)
    constrained_typevar_segments.append((6, 7, 8, 9))

def get_subsumed_segment() -> tuple[bool, bool]:
    return (True, False)

subsumed_segments = [get_subsumed_segment(), (1, 2), (3, 4, 5)]
reveal_type(subsumed_segments)  # revealed: list[tuple[int, int, int, int] | tuple[int, int] | tuple[int, int, int]]
subsumed_segments.append((6, 7, 8, 9))

def get_short_subsumed_segment() -> tuple[bool]:
    return (True,)

short_subsumed_segments = [get_short_subsumed_segment(), (1, 2), (3, 4, 5)]
reveal_type(short_subsumed_segments)  # revealed: list[tuple[int, int, int, int] | tuple[bool] | tuple[int, int] | tuple[int, int, int]]
...
reveal_type(heterogeneous_subsumed_segments)  # revealed: list[tuple[int, int, int, int] | tuple[int, int] | tuple[int, int, int]]
heterogeneous_subsumed_segments.append((6, 7, 8, 9))
...
def check_intersection_segment(segment: tuple[int, int]) -> None:
    if is_p(segment):
        ...
        reveal_type(intersection_segments)  # revealed: list[tuple[int, int, int, int] | tuple[int, int] | tuple[int, int, int]]
        intersection_segments.append((6, 7, 8, 9))
```
